...
var FlipView = /** @class */ (function (_super) {
    ...
    FlipView.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({ ref: function (element) { return _this.rootElm = element; }, className: theme.classNames(classes.root.className, className), onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave }, attributes, classes.root),
            count > 1 && _showNavigation && (React.createElement(IconButton_1.default, { onClick: this.swipeBackWord, style: styles.iconLeft, hoverStyle: {
            ...
            count > 1 && _showNavigation && (React.createElement(IconButton_1.default, { onClick: this.swipeForward, style: styles.iconRight, hoverStyle: {
                    background: theme.baseLow
                }, activeStyle: {
                    background: theme.accent,
                    color: "#fff"
