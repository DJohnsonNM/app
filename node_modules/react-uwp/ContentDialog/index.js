...
var ContentDialog = /** @class */ (function (_super) {
    ...
    ContentDialog.prototype.render = function () {
        ...
        return (React.createElement(RenderToBody_1.default, { ref: function (renderToBody) { return _this.renderToBody = renderToBody; } },
            React.createElement("div", __assign({}, attributes, { style: classes.mask.style, className: theme.classNames(classes.mask.className, className) }),
                React.createElement("div", __assign({ ref: function (rootElm) { return _this.rootElm = rootElm; } }, classes.container, { onMouseEnter: this.containerMouseEnterHandle, onMouseLeave: this.containerMouseLeaveHandle }),
                    statusBarTitle && React.createElement("div", __assign({}, classes.statusBar),
                        React.createElement("p", __assign({}, classes.statusBarTitle), statusBarTitle),
                        showCloseButton
                            ?
                                React.createElement(IconButton_1.default, { onClick: closeButtonAction, size: 24, style: styles.iconButton, hoverStyle: iconButtonHoverStyle, activeStyle: iconButtonHoverStyle }, "\uE894")
                            : null),
                    React.createElement("div", __assign({}, classes.titleWrapper),
                        title ? React.createElement("h5", __assign({}, classes.title), title) : null,
                        content && React.createElement("p", null, content)),
                    contentNode,
                    React.createElement("div", __assign({}, classes.content), (primaryButtonText || secondaryButtonText) && React.createElement("div", __assign({}, classes.buttonGroup),
                        primaryButtonText && React.createElement(Button_1.default, { onClick: function (e) { primaryButtonAction(e), _this.closeDialog(); }, style: styles.button }, primaryButtonText),
                        secondaryButtonText && React.createElement(Button_1.default, { onClick: function (e) { secondaryButtonAction(e), _this.closeDialog(); }, style: styles.button }, secondaryButtonText)))))));
    };
