...
var CalendarDatePicker = /** @class */ (function (_super) {
    ...
    CalendarDatePicker.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({}, classes.root, { onClick: this.toggleShowCalendarView, ref: function (rootElm) { return _this.rootElm = rootElm; } }),
            React.createElement(TextBox_1.default, __assign({}, attributes, { ref: function (textBox) { return _this.textBox = textBox; }, style: styles.input, placeholder: isInit ? placeholder : mmddyy, disabled: true, rightNode: React.createElement(Icon_1.default, { style: styles.icon }, "Calendar") })),
            React.createElement(CalendarView_1.default, { style: styles.calendarView, defaultDate: defaultDate, onChangeDate: this.handleChangeDate })));
    };
