...
export default class YearPicker extends React.Component<YearPickerProps, {}> {
    ...
    handleMouseEnter: (e: React.MouseEvent<HTMLButtonElement, MouseEvent>, isNow: boolean) => void;
    handleMouseLeave: (e: React.MouseEvent<HTMLButtonElement, MouseEvent>, isNow: boolean) => void;
    getYearsArray: () => any[];
    render(): JSX.Element;
}
