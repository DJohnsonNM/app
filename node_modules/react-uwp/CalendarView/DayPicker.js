...
var DayPicker = /** @class */ (function (_super) {
    ...
    DayPicker.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({}, classes.container),
            React.createElement("div", __assign({}, classes.weeklyHead), dateUtils.dayShortList.map(function (str, index) { return (React.createElement("button", __assign({}, classes.weeklyHeadItem, { key: "" + index }), str)); })),
            React.createElement(SlideInOut_1.default, __assign({}, attributes, { style: styles.root, mode: "both", speed: 350, direction: direction, appearAnimate: false }),
                React.createElement("div", { key: date.getFullYear() + ", " + date.getMonth() + " " + date.getDate() }, days.map(function (_a, index) {
                    ...
                    return React.createElement("button", { onMouseEnter: function (e) { return _this.handleMouseEnter(e, date, isCurrMonth, isNow); }, onMouseLeave: function (e) { return _this.handleMouseLeave(e, date, isCurrMonth, isNow); }, style: __assign(__assign({}, classes.dayItem.style), { position: "relative", border: theme.borderWidth + "px solid " + theme.baseLow, color: isCurrMonth ? theme.baseHigh : theme.baseLow, background: (isNow || isChoose) ? (isNow ? theme.accent : theme.listAccentLow) : (isCurrMonth ? (theme.useFluentDesign ? theme.altLow : theme.altHigh) : (theme.useFluentDesign ? theme.listLow : theme.chromeLow)) }), className: classes.dayItem.className, onClick: function () { return onChooseDay(date); }, key: "" + index },
                        day,
