...
var MarkdownRender = /** @class */ (function (_super) {
    ...
    function MarkdownRender() {
        ...
        _this.getMd = function () {
            var md = _this.props.md;
            if (md) {
                return md;
            }
            else {
    ...
    MarkdownRender.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", __assign({}, attributes, { className: this.getClassName() + " " + (className || ""), dangerouslySetInnerHTML: { __html: html } }))));
    };
...
function getMarkdownCSSText(theme, className, fontSize) {
...
exports.getMarkdownCSSText = getMarkdownCSSText;
