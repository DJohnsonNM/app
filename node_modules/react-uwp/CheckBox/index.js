...
var CheckBox = /** @class */ (function (_super) {
    ...
    CheckBox.prototype.render = function () {
        ...
        var checkbox = (React.createElement(PseudoClasses_1.default, __assign({}, classes.iconParent, { disabled: disabled }),
            React.createElement("div", { ref: function (rootElm) { return _this.rootElm = rootElm; } },
                React.createElement(Icon_1.default, { style: styles.icon }, "CheckMarkZeroWidthLegacy"))));
        return (React.createElement("div", __assign({}, attributes, { onClick: this.handleClick }, classes.wrapper), haveLabel ? (React.createElement("div", __assign({}, classes.root),
            checkbox,
            label !== void 0 && (React.createElement("span", __assign({}, classes.label), label)))) : checkbox));
    };
