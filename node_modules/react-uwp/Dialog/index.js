...
var Dialog = /** @class */ (function (_super) {
    ...
    Dialog.prototype.render = function () {
        ...
        return (React.createElement(RenderToBody_1.default, __assign({}, attributes, { style: classes.root.style, ref: function (renderToBody) { return _this.renderToBody = renderToBody; }, className: theme.classNames(classes.root.className, className) }),
            React.createElement("div", __assign({ ref: function (rootElm) { return _this.rootElm = rootElm; } }, classes.content), children)));
    };
    Dialog.defaultProps = {
