...
var AutoSuggestBox = /** @class */ (function (_super) {
    ...
    AutoSuggestBox.prototype.render = function () {
        ...
        return (React.createElement(TextBox_1.default, __assign({}, attributes, { style: styles.root, ref: function (textBox) { return _this.textBox = textBox; }, onClick: this.showListSource, onKeyDown: this.handleInputKeyDown, rightNode: React.createElement(PseudoClasses_1.default, { style: styles.icon, onClick: this.handleButtonAction },
                React.createElement(Icon_1.default, null, typing ? "CancelLegacy" : "Search")), background: background, onChange: this.handleChange }), listSource && listSource.length > 0 && (React.createElement(ListView_1.default, { ref: function (listView) { return _this.listView = listView; }, style: styles.listView, listSource: listSource.map(function (itemNode, index) { return ({
                itemNode: itemNode,
