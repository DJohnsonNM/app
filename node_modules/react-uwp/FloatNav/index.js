...
var FloatNav = /** @class */ (function (_super) {
    ...
    FloatNav.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({}, attributes, classes.root, { className: theme.classNames(classes.root.className, className) }),
            React.createElement("div", __assign({}, attributes, classes.wrapper),
...
function getStyles(floatNav) {
    ...
    return {
        root: prefixStyle(__assign({ width: initWidth, background: theme.altHigh }, style)),
        wrapper: prefixStyle(__assign({ width: initWidth, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: isFloatRight ? "flex-end" : "flex-start" }, style)),
        button: {
