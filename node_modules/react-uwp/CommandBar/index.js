...
var CommandBar = /** @class */ (function (_super) {
    ...
    CommandBar.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({}, classes.wrapper, { ref: function (rootElm) { return _this.rootElm = rootElm; } }),
            React.createElement("div", __assign({}, attributes, classes.root),
                (content !== void 0 || contentNode !== void 0) && (React.createElement("div", __assign({}, classes.content), content || contentNode)),
                React.createElement("div", __assign({}, classes.commands),
                    ...
                    React.createElement(AppBarButton_1.default, { labelPosition: "bottom", revealConfig: {
                            effectEnable: "disabled"
                        }, style: styles.moreLegacy, iconStyle: {
                            maxWidth: defaultHeight,
                            height: defaultHeight,
                            lineHeight: isMinimal ? (expanded ? "48px" : "24px") : "48px"
                        }, icon: "MoreLegacy", onClick: this.toggleExpanded }),
                    secondaryCommands && (React.createElement(ListView_1.default, { style: styles.secondaryCommands, listSource: secondaryCommands.map(function (itemNode) {
