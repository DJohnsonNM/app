...
function getStripedBackground(size, firstColor, secondColor) {
    ...
    return "linear-gradient(45deg, " + firstColor + " 25%, " + secondColor + " 0px, " + secondColor + " 50%, " + firstColor + " 0px, " + firstColor + " 75%, " + secondColor + " 0px) 0% 0% / " + size + "px " + size + "px " + firstColor;
}
exports.getStripedBackground = getStripedBackground;
